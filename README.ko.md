# 안녕하세요, Ubucon! 12-factor FastAPI 배포에 오신 것을 환영합니다!
...
이 섹션은 Juju와 K8s에서 FastAPI 애플리케이션을 배포하는 방법을 안내합니다!
...
```bash
charmcraft upload ./fastapi-hello-world/charm/fastapi-hello-world_amd64.charm
...
```bash
juju integrate fastapi-hello-world ingress-configurator
```
