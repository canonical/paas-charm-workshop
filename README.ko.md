# 안녕하세요, Ubucon! 12-factor Flask charm에 오신 것을 환영합니다!
...
배포 시작! [다음 브랜치](https://github.com/canonical/paas-charm-workshop/tree/flask-03-deploy) `git checkout flask-03-deploy`을 확인하세요.
