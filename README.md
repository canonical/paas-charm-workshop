# Hello Ubucon! Welcome to 12-factor Django charm!
...
Let's start getting our hands dirty! Check out the [next branch](https://github.com/canonical/paas-charm-workshop/tree/django-03-deploy) `git checkout django-03-deploy`
