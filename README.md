...
Let's start getting our hands dirty! Check out the [next branch](https://github.com/canonical/paas-charm-workshop/tree/go-03-deploy) `git checkout go-03-deploy`
