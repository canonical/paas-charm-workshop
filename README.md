...
This section guides you through deploying a Go application on Juju and K8s!
...
```bash
charmcraft register go-hello-world
...
```bash
juju integrate go-hello-world ingress-configurator
```
